...
import  tp6.modele.Probleme;

/**
 * représente un probleme d'un agent qui se déplace dans un labyrinthe et qui
 * peut avancer de deux cases quand il demande à se déplacer
 * 
...
public class ProblemeDevant extends Probleme<StateXYO, ActionOriente> {
	...
	/**
	 * objectifs a atteindre et valeur associée
	 */
	...
	/**
	 * donne une recompense en fonction de l'état d'arrivée
	 * 
	 * @param suivant
	 * @return
	 */
