...
import  tp6.modele.AbstractAction;

/**
 * classe qui represente les actions du probleme Devant
 * <li>action gauche consistant à changer son orientation
 * <li>action droite consistant à changer son orientation
...
public class ActionOriente extends AbstractAction {
	...
	/**
	 * constructeur des actions orientees (en prive pour éviter de creer
	 * n'importe quelle action à l'exterieur)
	 * 
	 * @param s
	 *            nom de l'action
	 */
	 ...
	 * 
	 * @return l'etat obtenu lorsque l'action se déroule une fois
	 */
